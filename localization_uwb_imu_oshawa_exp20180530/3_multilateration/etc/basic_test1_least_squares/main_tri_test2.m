...
mat_a = [1, -2*pos_station_uwb100(1), -2*pos_station_uwb100(2), -2*pos_station_uwb100(3); 
         1, -2*pos_station_uwb101(1), -2*pos_station_uwb101(2), -2*pos_station_uwb101(3); 
         1, -2*pos_station_uwb102(1), -2*pos_station_uwb102(2), -2*pos_station_uwb102(3); 
         1, -2*pos_station_uwb103(1), -2*pos_station_uwb103(2), -2*pos_station_uwb103(3); 
         ];
     
mat_b = [range_uwb100^2 - pos_station_uwb100(1)^2 - pos_station_uwb100(2)^2 - pos_station_uwb100(3)^2;
         range_uwb101^2 - pos_station_uwb101(1)^2 - pos_station_uwb101(2)^2 - pos_station_uwb101(3)^2;
         range_uwb102^2 - pos_station_uwb102(1)^2 - pos_station_uwb102(2)^2 - pos_station_uwb102(3)^2;
         range_uwb103^2 - pos_station_uwb103(1)^2 - pos_station_uwb103(2)^2 - pos_station_uwb103(3)^2;
        ];
