...
private:
  ...
  private:
    ...
    double          time_nsec_att_this;     // for DJI-attitude
    double          time_nsec_att_prev;

    double          time_nsec_ori_this;     // for DJI-imu orientation
    double          time_nsec_ori_prev;

    double          time_nsec_uwb_this;     // only for DJI-attitude
    double          time_nsec_uwb_prev;
