...
{  
  ...
  if(b_subs_orn) { m_subs_orn = m_nh.subscribe("dji_sdk/imu",          10, &CLS_sensor::callback_dji_orientation,  this); }
...
void CLS_sensor::callback_dji_attitude(const geometry_msgs::QuaternionStamped::ConstPtr& msg)
{
  ...
  if( m_pobj_loc != NULL )
  {
    ...
    MySensorData data_this;
      ...
      data_this.data_quaternion = att_this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CLS_sensor::callback_dji_orientation(const sensor_msgs::Imu::ConstPtr& msg)
{
  ////////////////////////////////////////////////////////////////////////////////////////////////////////
  //// callback for dji orientation
  ////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if( m_pobj_loc != NULL )
  {
    ...
    MySensorData data_this;
      ...
      data_this.time_this       = time_this;
      data_this.sensor_type     = SENSORDATA_DJI_IMU_ORIENTATION;
      data_this.data_quaternion = orn_this;
