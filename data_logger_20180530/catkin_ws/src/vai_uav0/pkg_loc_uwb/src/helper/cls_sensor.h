...
class CLS_sensor
{
  public:
    ...
    void callback_dji_attitude   (const geometry_msgs::QuaternionStamped::ConstPtr& msg);
    void callback_dji_imu        (const sensor_msgs::Imu::ConstPtr& msg);
    void callback_dji_height     (const std_msgs::Float32::ConstPtr& msg);
  ...
  private:
    ...
    ros::Subscriber m_subs_att;
    ros::Subscriber m_subs_orn;
    ros::Subscriber m_subs_hei;
