...
function [res_pos_mover_est] = func_solve5(B_show_msg, P, range_mea_set, W, w_set_norm)
...
Nmat0_a = RecTrilateration_solve5_c123(P, range_mea_set, W);
Nmat0_b = RecTrilateration_solve5_c134(P, range_mea_set, W);
Nmat0_c = RecTrilateration_solve5_c234(P, range_mea_set, W);
